!(function () {
  ...
  function n() {
    var t,
      o,
      n,
      r = document.querySelector(".experience-section .experience__timePath"),
      i = gsap.utils.toArray(".experience-section .experience__timeline__item");
    if (
      ((r || i.length) &&
        (!(function (t, o) {
          var n = e(Array(Math.floor((o.length - 1) / 3)));
          t.insertAdjacentHTML("afterbegin", '<span class="line"></span>'),
            n.forEach(function () {
      ...
      var a = gsap.utils.toArray(
        ".experience-section .experience__timePath span"
      );
      t = gsap.timeline();
      ...
      t
        .set(a, { autoAlpha: 1 })
        .set(d, { clipPath: u.x[l] })
        .set(m, { clipPath: u.x[c] })
        .set(f, { clipPath: u.c[l] })
        .set(p, { clipPath: u.c[c] }),
        a.forEach(function (e) {
          d.includes(e) || m.includes(e)
            ? t.to(e, { clipPath: u.x.to })
            : f.includes(e)
            ? t
                .to(e, { clipPath: u.c.to[l].st1 })
                .to(e, { clipPath: u.c.to[l].st2 })
                .to(e, { clipPath: u.c.to[l].st3 })
            : p.includes(e) &&
              t
                .to(e, { clipPath: u.c.to[c].st1 })
                .to(e, { clipPath: u.c.to[c].st2 })
                .to(e, { clipPath: u.c.to[c].st3 });
        }),
        n.add(t);
    }
    i.length &&
      ...
      i.forEach(function (e) {
        o.from(e, { autoAlpha: 0 }).from(e, { scale: 0.2 }, "<");
      }),
      n.add(o, "< +=0.5"));
  }
  ...
  function d(e) {
    ...
    if (u) {
      var i = u.children.length,
        ...
        s = function () {
          u.insertAdjacentHTML(
            "beforeend",
            '<li id="'
              .concat(a, '" class="notifications__item notify-enter ')
              .concat(
                o,
      ...
      t ? !u.querySelector("#".concat(t)) && s() : s(),
        r && f(document.getElementById(a), 5e3);
    }
  }
  function m(e) {
  ...
  function f(e) {
    ...
    e.classList.remove("notify-enter"),
      setTimeout(function () {
  ...
  function p() {
    var e,
      t,
      o,
      n = document.querySelector(".contact-section .contact__form"),
    ...
    "" === r.value
      ? ((u.name.required = !0),
        d({
          id: "nameRequired",
          type: "danger",
          msg: r.closest(".control").querySelector(".errors-msgs .required")
            .value,
        }))
      : ((u.name.required = !1), m("nameRequired")),
      r.value.length > 0 && r.value.length < r.getAttribute("minlength")
        ? ((u.name.minLength = !0),
          d({
            id: "nameMinLength",
            type: "danger",
            msg: r.closest(".control").querySelector(".errors-msgs .minLength")
              .value,
          }))
        : ((u.name.minLength = !1), m("nameMinLength")),
      Object.keys(u.name).some(function (e) {
        return !0 === u.name[e];
      })
      ...
      "" === i.value
        ? ((u.email.required = !0),
          d({
            id: "emailRequired",
            type: "danger",
            msg: i.closest(".control").querySelector(".errors-msgs .required")
              .value,
          }))
        : ((u.email.required = !1), m("emailRequired")),
      i.value.length > 0 &&
      !/^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$/.test(
        ...
        ? ((u.email.invalid = !0),
          d({
            id: "emailInvalid",
            type: "danger",
            msg: i.closest(".control").querySelector(".errors-msgs .invalid")
              .value,
          }))
        : ((u.email.invalid = !1), m("emailInvalid")),
      Object.keys(u.email).some(function (e) {
        return !0 === u.email[e];
      })
      ...
      !/^[\+]?[(]?[0-9]{3}[)]?[-\s\.]?[0-9]{3}[-\s\.]?[0-9]{4,6}$/im.test(
        ...
        ? ((u.phone.invalid = !0),
          d({
            id: "phoneInvalid",
            type: "danger",
            msg: a.closest(".control").querySelector(".errors-msgs .invalid")
              .value,
          }))
        : ((u.phone.invalid = !1), m("phoneInvalid")),
      Object.keys(u.phone).some(function (e) {
        return !0 === u.phone[e];
      })
        ? (a.classList.remove("valid"), a.classList.add("invalid"))
        : (a.classList.remove("invalid"), a.classList.add("valid")),
      "" === c.value
        ? ((u.message.required = !0),
          d({
            id: "messageRequired",
            type: "danger",
            msg: c.closest(".control").querySelector(".errors-msgs .required")
              .value,
          }))
        : ((u.message.required = !1), m("messageRequired")),
      Object.keys(u.message).some(function (e) {
        return !0 === u.message[e];
      })
        ? (c.classList.remove("valid"), c.classList.add("invalid"))
        : (c.classList.remove("invalid"), c.classList.add("valid")),
      !Object.values(u).some(function (e) {
        ...
        (o = new FormData(e)),
        s(),
        fetch(t, { method: "POST", body: o })
          .then(function (e) {
            return e.text();
          })
          .then(function (t) {
            "success" === t
              ? (d({ type: "success", msg: e.dataset.successMsg }),
                e.reset(),
                e.querySelectorAll(".valid").forEach(function (e) {
                  return e.classList.remove("valid");
                }))
              : "error" === t && d({ type: "danger", msg: e.dataset.errMsg }),
              l(),
              console.log(t);
          })
          .catch(function (e) {
  ...
  function g() {
    ...
    gsap.registerPlugin(ScrollTrigger),
      ...
      (e = gsap.utils.toArray(".skills-section .skills__items")).length &&
        e.forEach(function (e) {
          var t = gsap.timeline({
            scrollTrigger: {
      ...
      (function () {
        if (r) {
          ...
          e.forEach(function (e, o) {
            var n = 0 === o ? "" : "< +=0.2";
            t.from(e, { autoAlpha: 0 }, n).from(e, { scale: 0.2 }, "<");
          });
        }
      })(),
      (function () {
        ...
        if (e.length) {
          ...
          e.forEach(function (e, o) {
            ...
            t
              ...
              .from(
                ".contact-section .contact__social__item",
                { y: 50, stagger: 0.2 },
                "<"
              );
        }
      })(),
      document.querySelector(".contact-section .contact__form") &&
        gsap
          .timeline({
            scrollTrigger: {
  ...
  u.addEventListener("click", function (e) {
    ...
    null !== (t = e.target) &&
      void 0 !== t &&
      t.classList.contains("notifications__dismiss") &&
  ...
  function v() {
    ...
    if (e) {
      var t = window.pageYOffset,
        ...
        n = t > 100 && t > y;
      o
        ? e.classList.add("header--expanded")
        : e.classList.remove("header--expanded"),
        o
          ? e.classList.remove("header--semi-minimized")
          : e.classList.add("header--semi-minimized"),
        n
          ? e.classList.add("header--minimized")
          : e.classList.remove("header--minimized"),
        (y = t);
    }
  }
  ...
  function _() {
    ...
    (document.documentElement.dataset.mode = e),
      h && (h.dataset.mode = e),
      localStorage.setItem("nafieSavedMode", e);
  }
  function b() {
  ...
  function L() {
    A.classList.contains("menu-open")
      ? S()
      : (A.classList.add("menu-open"),
        q.classList.add("open"),
        document.body.style.setProperty("overflow-y", "hidden"),
        A.querySelector(".offCanvasMenu").focus());
  }
  function S() {
  ...
  function x() {
    w &&
      VanillaTilt.init(w.querySelectorAll(".portfolio__item"), {
        max: 8,
        speed: 400,
        glare: !0,
        "max-glare": 0.3,
  ...
  function k(t) {
    ...
    o.forEach(function (e) {
      ...
      e(w.querySelectorAll(".portfolio__item:not([hidden])")).filter(function (
        e
      ) {
        e.style.setProperty("display", "none"),
          (e.dataset.filter !== n && "all" !== n) ||
            setTimeout(function () {
  ...
  function P(t) {
    ...
    n.length
      ? (e(n)
        ...
        T())
      : d({ type: "danger", msg: o, autoHide: !0 }),
      l();
  }
  function T() {
    x(),
    ...
    !(function () {
      ...
      if (o) {
        var n = o.querySelector(".preloader__content"),
          ...
          i = r.length,
          a = function () {
            o.setAttribute("style", "--loading-percentage: 100%"),
              gsap
                .timeline()
                .set(".hide-in-preloading", { autoAlpha: 1 })
                .to(n, { delay: 0.5, autoAlpha: 0 })
                .to(o, { y: "-100%", duration: 1, ease: "expo.in" }, "-=0.5")
                .set(o, { autoAlpha: 0 });
          },
          s = function () {
            t++;
            var e = ((100 / i) * t) << 0;
            o.setAttribute("style", "--loading-percentage: ".concat(e, "%")),
              t === i && a();
          };
        i
      ...
      window.innerWidth >= 992 &&
        ((t = document.getElementById("app-inner")),
        (n = document.querySelector(".circle-cursor-outer")),
        (r = document.querySelector(".circle-cursor-inner")),
        n &&
          r &&
          (t.addEventListener("mousemove", function (e) {
            n.setAttribute(
              ...
              e.target.closest(".link-hover")
                ? r.classList.add("cursor-link-hover")
                : r.classList.remove("cursor-link-hover");
          }),
          t.addEventListener("click", function () {
            r.classList.add("cursor-click-effect"),
              setTimeout(function () {
        ...
        (function () {
          ...
          if (e && e.dataset.hasOwnProperty("panEffect")) {
            ...
            e.addEventListener("mousemove", function (o) {
              var n =
                  ((o.x - e.getBoundingClientRect().x) / e.offsetWidth) * 100,
                r =
                  ((o.y - e.getBoundingClientRect().y) / e.offsetHeight) * 100;
              t[0].setAttribute(
                "style",
                "transform-origin: ".concat(n, "vw ").concat(r, "vh;")
              ),
                t[1].setAttribute(
                  "style",
                  "transform-origin: ".concat(n, "vw ").concat(r, "vh;")
        ...
        x()),
      (i = document.getElementById("app-inner")),
      (a = i.classList),
      ...
      v(),
      (s = localStorage.getItem("nafieSavedMode"))
        ? _(s)
        : window.matchMedia
        ? window.matchMedia("(prefers-color-scheme: dark)").matches
          ...
          : _("light")
        : _(),
      (window._toggleAppMode = b),
      (window._offCanvasMenuToggle = L),
      (window._offCanvasMenuClose = S),
      ...
      document.querySelectorAll("[data-tooltip]").forEach(function (e) {
        ...
        e.classList.add("has-tooltip"),
          e.insertAdjacentHTML(
            "beforeend",
            '<div class="simple-tooltip tooltip-'
              .concat(t.dir, '">')
              .concat(t.text, "</div>")
          );
      }),
      ...
      (m = document.querySelectorAll(
        '.skills-section .skills__text__switcher input[name="items_type"]'
      )),
      (f = document.querySelectorAll(
        ".skills-section .skills__wrapper .skills__items"
      )),
      m.forEach(function (e) {
        e.addEventListener("change", function (e) {
          f.forEach(function (t) {
            t.dataset.type === e.target.value
              ? t.style.removeProperty("display")
              : t.style.setProperty("display", "none");
          });
        });
      }),
      (window._filterPortfolioItems = k),
      (window._loadMorePortfolioItems = P),
      w &&
        e(E)
          .slice(7)
          .forEach(function (e) {
